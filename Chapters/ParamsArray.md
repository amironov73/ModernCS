### Структура ParamsArray

Наткнулся в исходниках CLR на хитрую структуру [`ParamsArray`](https://github.com/dotnet/runtime/blob/main/src/libraries/System.Private.CoreLib/src/System/ParamsArray.cs):
